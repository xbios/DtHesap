...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-gray-900">Banka Hesabı Düzenle: {{ $banka->banka_adi }}</h2>
            <a href="{{ route('bankas.index') }}" class="text-gray-600 hover:text-gray-900">Geri Dön</a>
        </div>

        <div class="bg-white shadow rounded-lg p-6">
            <form action="{{ route('bankas.update', $banka) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="kod" id="kod" value="{{ old('kod', $banka->kod) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="banka_adi" id="banka_adi" value="{{ old('banka_adi', $banka->banka_adi) }}"
                            required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="sube_adi" id="sube_adi" value="{{ old('sube_adi', $banka->sube_adi) }}"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="sube_kodu" id="sube_kodu" value="{{ old('sube_kodu', $banka->sube_kodu) }}"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="hesap_no" id="hesap_no" value="{{ old('hesap_no', $banka->hesap_no) }}"
                            required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="iban" id="iban" value="{{ old('iban', $banka->iban) }}"
                            placeholder="TR00..."
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select name="doviz_tip" id="doviz_tip" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="TRY" {{ old('doviz_tip', $banka->doviz_tip) == 'TRY' ? 'selected' : '' }}>TRY
                            </option>
                            <option value="USD" {{ old('doviz_tip', $banka->doviz_tip) == 'USD' ? 'selected' : '' }}>USD
                            </option>
                            <option value="EUR" {{ old('doviz_tip', $banka->doviz_tip) == 'EUR' ? 'selected' : '' }}>EUR
                            </option>
                            <option value="GBP" {{ old('doviz_tip', $banka->doviz_tip) == 'GBP' ? 'selected' : '' }}>GBP
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="is_active" id="is_active"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="1" {{ old('is_active', $banka->is_active) == '1' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ old('is_active', $banka->is_active) == '0' ? 'selected' : '' }}>Pasif
                            </option>
                        </select>
                ...
                <div>
                    ...
                    <textarea name="aciklama" id="aciklama" rows="3"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('aciklama', $banka->aciklama) }}</textarea>
