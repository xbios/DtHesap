...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Yeni Stok Kartı</h2>
            ...
            <form action="{{ route('stoks.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kod" value="{{ old('kod') }}" required
                    ...
                    <div>
                        ...
                        <select name="birim"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="Adet" {{ old('birim') == 'Adet' ? 'selected' : '' }}>Adet</option>
                            <option value="KG" {{ old('birim') == 'KG' ? 'selected' : '' }}>Kilogram</option>
                            <option value="Litre" {{ old('birim') == 'Litre' ? 'selected' : '' }}>Litre</option>
                            <option value="Metre" {{ old('birim') == 'Metre' ? 'selected' : '' }}>Metre</option>
                            <option value="Kutu" {{ old('birim') == 'Kutu' ? 'selected' : '' }}>Kutu</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="barkod" value="{{ old('barkod') }}"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="kdv_oran" value="{{ old('kdv_oran', 20) }}" step="0.01"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="alis_fiyat" value="{{ old('alis_fiyat', 0) }}" step="0.01"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Satış Fiyatı</label>
                        <input type="number" name="satis_fiyat" value="{{ old('satis_fiyat', 0) }}" step="0.01"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="min_stok" value="{{ old('min_stok', 0) }}" step="0.001"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Max. Stok</label>
                        <input type="number" name="max_stok" value="{{ old('max_stok', 0) }}" step="0.001"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                </div>
